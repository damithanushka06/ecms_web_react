...
export default function UnderInvestigation() {
    ...
    const complaintColumns = [
        {field: 'createdOn', headerName: 'Complained Date', width: 200},
        ...
        },
        {
            field: 'id', headerName: 'Action', width: 300, renderCell: (params) => (
                <div style={{whiteSpace: 'pre-line', paddingTop: 10, paddingBottom: 10}}>
                    {/*<Button variant="contained" color={'success'} onClick={() => handleReserve(params.value)}>Reserve</Button>*/}
    ...
    const handleClose = (complaintId) => {
        ...
        axios.get('http://localhost:8080/api/complain/update_complain_status', {
            ...
            params: { complaintId: complaintId, status: 'C'}
        })
            .then(response => {
